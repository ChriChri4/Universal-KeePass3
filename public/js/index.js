        ...
        success: function(result){
            ...
            function loadTableData(result) {
                ...
                for (let risultato of result) {
                    dati += `<tr><td>${risultato.description}</td><td id="${i} key" class="${i} keys" style="visibility:hidden">${risultato.key}</td><td>${risultato.email}</td><td><input type="button" id="${i}service" value="Delete this Service" onclick="deleteRow(this)">&nbsp<input type="button" id="${i}service" value="Show/Hide" onclick="showPSSW(this)"></td></tr>`
                    i++
                }
